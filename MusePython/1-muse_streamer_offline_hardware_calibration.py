...
def run_preflight_check():
    ...
    for attempt in range(max_attempts):
        ...
        # Overwrite the previous console output for a cleaner "dashboard" feel
        ...
        # Move cursor back up 5 lines to overwrite next loop
        sys.stdout.write("\033[5A")

    # Move cursor down past the output block if it fails
...
def force_window_to_front():
    """Background thread to force the viewer window to the top while ignoring dummy windows."""
